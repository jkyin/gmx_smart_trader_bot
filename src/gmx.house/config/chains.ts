...
export const CHAIN_NAMES_MAP: { [index: number]: string } = {
  [MAINNET]: 'BSC',
  [TESTNET]: 'BSC Testnet',
...
export const HIGH_EXECUTION_FEES_MAP: { [index: number]: number } = {
  [ARBITRUM]: 3, // 3 USD
  [AVALANCHE]: 3, // 3 USD
};
...
interface Constants {
  [key: number]: {
    ...
    v2: boolean;
    SWAP_ORDER_EXECUTION_GAS_FEE?: bigint;
    INCREASE_ORDER_EXECUTION_GAS_FEE?: bigint;
    DECREASE_ORDER_EXECUTION_GAS_FEE?: bigint;
...
export const RPC_PROVIDERS: { [index: number]: string[] } = {
...
export const FALLBACK_PROVIDERS: { [index: number]: string[] } = {
